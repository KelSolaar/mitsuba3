    ...
    def sample(self,
        ...
        while loop(active):
            ...
            with dr.resume_grad(when=not is_primal):
                ...
                tr, free_flight_pdf = medium.transmission_eval_pdf(mei, si, active_medium)
    ...
    def sample_emitter(self, mei, si, active_medium, active_surface, scene, sampler, medium, channel,
        ...
        while loop(active):
            ...
            if self.nee_handle_homogeneous:
                ...
                tr_multiplier[active_homogeneous] = medium.transmission_eval_pdf(mei, si, active_homogeneous)[0]
